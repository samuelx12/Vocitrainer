...
"border-color: rgb(201, 220, 225);")
        ...
        self.f_lbl_definition_beschreibung = QtWidgets.QLabel(self.frage_page)
        self.f_lbl_definition_beschreibung.setObjectName("f_lbl_definition_beschreibung")
        self.verticalLayout.addWidget(self.f_lbl_definition_beschreibung)
        self.f_lbl_definition_wort = QtWidgets.QLabel(self.frage_page)
        self.f_lbl_definition_wort.setWordWrap(True)
        self.f_lbl_definition_wort.setObjectName("f_lbl_definition_wort")
        self.verticalLayout.addWidget(self.f_lbl_definition_wort)
...
"border-color: rgb(201, 220, 225);")
        ...
        self.a_lbl_fremdsprache_wort.setStyleSheet("background-color: rgb(201, 220, 225);\n"
"border: 3px solid;\n"
"border-radius: 3px;\n"
"border-color: rgb(201, 220, 225);")
...
"border-color: rgb(184, 225, 210);")
    ...
    def retranslateUi(self, Trainingsfenster):
        ...
        self.f_lbl_definition_beschreibung.setText(_translate("Trainingsfenster", "Definition:"))
        self.f_lbl_definition_wort.setText(_translate("Trainingsfenster", "DEFINTION DEFINITION DEFINTION aösdlfkjasdfljasdlöfkj aölskdjf alökdsfj aölsfj aösldkfj aösdlkfj alösdkfj aölsdkfj aölsdkfj aölsdkfj aölsdkfj aölkdsfj aöllskdjf aölskdfj aölskdfj aölskdjf aölsdkfj aölskdfj aölskdfj aöldkfj "))

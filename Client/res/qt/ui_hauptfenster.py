...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cmd_Aktion = QtWidgets.QFrame(self.centralwidget)
        self.cmd_Aktion.setStyleSheet("QFrame {\n"
...
"    background-color: rgba(0, 0, 0, 0);\n"
"}")
        self.cmd_Aktion.setFrameShape(QtWidgets.QFrame.Box)
        self.cmd_Aktion.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.cmd_Aktion.setLineWidth(1)
        self.cmd_Aktion.setObjectName("cmd_Aktion")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.cmd_Aktion)
        ...
        self.cmd_lbl_Aktion = QtWidgets.QLabel(self.cmd_Aktion)
        self.cmd_lbl_Aktion.setAlignment(QtCore.Qt.AlignCenter)
        self.cmd_lbl_Aktion.setObjectName("cmd_lbl_Aktion")
        self.verticalLayout.addWidget(self.cmd_lbl_Aktion)
        self.horizontalLayout.addWidget(self.cmd_Aktion)
...
"selection-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cmd_lbl_Aktion.setText(_translate("MainWindow", "Aktion"))

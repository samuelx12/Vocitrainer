...
class Ui_ImportCSV(object):
    def setupUi(self, ImportCSV):
        ...
        self.groupBox = QtWidgets.QGroupBox(ImportCSV)
        ...
        self.lbl_sprache = QtWidgets.QLabel(self.groupBox)
        self.lbl_sprache.setObjectName("lbl_sprache")
        self.horizontalLayout_8.addWidget(self.lbl_sprache)
        self.cmb_sprache = QtWidgets.QComboBox(self.groupBox)
        ...
        self.gruppe_datei = QtWidgets.QGroupBox(ImportCSV)
        self.gruppe_datei.setFlat(False)
        self.gruppe_datei.setCheckable(True)
        self.gruppe_datei.setObjectName("gruppe_datei")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.gruppe_datei)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.lbl_pfad = QtWidgets.QLabel(self.gruppe_datei)
        self.lbl_pfad.setObjectName("lbl_pfad")
        self.horizontalLayout.addWidget(self.lbl_pfad)
        self.txt_pfad = QtWidgets.QLineEdit(self.gruppe_datei)
        self.txt_pfad.setObjectName("txt_pfad")
        self.horizontalLayout.addWidget(self.txt_pfad)
        self.cmd_durchsuchen = QtWidgets.QPushButton(self.gruppe_datei)
        ...
        self.lbl_FehlerPfad = QtWidgets.QLabel(self.gruppe_datei)
        font = QtGui.QFont()
        ...
        self.verticalLayout_2.addWidget(self.lbl_FehlerPfad)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lbl_Vorschau = QtWidgets.QLabel(self.gruppe_datei)
        ...
        self.txt_Vorschau = QtWidgets.QTextEdit(self.gruppe_datei)
        ...
        self.verticalLayout_5.addWidget(self.txt_Vorschau)
        self.verticalLayout_2.addLayout(self.verticalLayout_5)
        self.verticalLayout_3.addWidget(self.gruppe_datei)
        self.gruppe_direkt = QtWidgets.QGroupBox(ImportCSV)
        self.gruppe_direkt.setCheckable(True)
        self.gruppe_direkt.setChecked(True)
        self.gruppe_direkt.setObjectName("gruppe_direkt")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.gruppe_direkt)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.txt_direktInput = QtWidgets.QTextEdit(self.gruppe_direkt)
        self.txt_direktInput.setObjectName("txt_direktInput")
        self.verticalLayout_7.addWidget(self.txt_direktInput)
        self.verticalLayout_3.addWidget(self.gruppe_direkt)
        self.groupBox_4 = QtWidgets.QGroupBox(ImportCSV)
        self.groupBox_4.setObjectName("groupBox_4")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.groupBox_4)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.lbl_trennzeichen = QtWidgets.QLabel(self.groupBox_4)
        self.lbl_trennzeichen.setObjectName("lbl_trennzeichen")
        self.horizontalLayout_3.addWidget(self.lbl_trennzeichen)
        self.txt_trennzeichen = QtWidgets.QLineEdit(self.groupBox_4)
        ...
        self.lbl_EigenschaftKarte = QtWidgets.QLabel(self.groupBox_4)
        self.lbl_EigenschaftKarte.setObjectName("lbl_EigenschaftKarte")
        self.verticalLayout_8.addWidget(self.lbl_EigenschaftKarte)
        ...
        self.int_spalteWort = QtWidgets.QSpinBox(self.groupBox_4)
        self.int_spalteWort.setObjectName("int_spalteWort")
        self.horizontalLayout_11.addWidget(self.int_spalteWort)
        self.lbl_muttersprache = QtWidgets.QLabel(self.groupBox_4)
    ...
    def retranslateUi(self, ImportCSV):
        ...
        self.groupBox.setTitle(_translate("ImportCSV", "Information"))
        ...
        self.gruppe_datei.setTitle(_translate("ImportCSV", "Quelle: Datei"))
        ...
        self.gruppe_direkt.setTitle(_translate("ImportCSV", "Quelle: Direkt"))
        self.groupBox_4.setTitle(_translate("ImportCSV", "Import Einstellungen"))

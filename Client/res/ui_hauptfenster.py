...
"selection-color: rgb(0, 0, 0);]")
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/res/icons/delete_FILL0_wght400_GRAD0_opsz24.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon18.addPixmap(QtGui.QPixmap(":/icons/res/icons/delete_FILL1_wght400_GRAD0_opsz24.svg"), QtGui.QIcon.Active, QtGui.QIcon.Off)

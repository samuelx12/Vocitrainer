...
"selection-color: rgb(0, 0, 0);]")
        ...
        self.actionTestAktion = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("../../../../../.designer/icons/delete_FILL0_wght500_GRAD0_opsz40.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTestAktion.setIcon(icon13)
        self.actionTestAktion.setObjectName("actionTestAktion")
        ...
        self.actionEinstellungen.setIcon(icon14)
        ...
        self.action_ber.setIcon(icon15)
        ...
        self.actionSet_lernen = QtWidgets.QAction(MainWindow)
        self.actionSet_lernen.setIcon(icon)
        self.actionSet_lernen.setObjectName("actionSet_lernen")
        self.actionSet_ben = QtWidgets.QAction(MainWindow)
        self.actionSet_ben.setIcon(icon1)
        self.actionSet_ben.setObjectName("actionSet_ben")
        self.actionAusgew_hlte_lernen = QtWidgets.QAction(MainWindow)
        self.actionAusgew_hlte_lernen.setIcon(icon2)
        self.actionAusgew_hlte_lernen.setObjectName("actionAusgew_hlte_lernen")
        self.actionMarkierte_lernen = QtWidgets.QAction(MainWindow)
        self.actionMarkierte_lernen.setIcon(icon3)
        self.actionMarkierte_lernen.setObjectName("actionMarkierte_lernen")
        ...
        self.menuVocitrainer.addAction(self.actionEinstellungen)
        self.menuVocitrainer.addAction(self.action_ber)
        self.menuVocitrainer.addAction(self.actionBeenden)
        self.menuLernen.addAction(self.actionSet_lernen)
        self.menuLernen.addAction(self.actionSet_ben)
        self.menuLernen.addSeparator()
        self.menuLernen.addAction(self.actionAusgew_hlte_lernen)
        self.menuLernen.addAction(self.actionMarkierte_lernen)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionTestAktion.setText(_translate("MainWindow", "TestAktion"))
        ...
        self.actionSet_lernen.setText(_translate("MainWindow", "Set lernen"))
        self.actionSet_ben.setText(_translate("MainWindow", "Set üben"))
        self.actionAusgew_hlte_lernen.setText(_translate("MainWindow", "Ausgewählte lernen"))
        self.actionMarkierte_lernen.setText(_translate("MainWindow", "Markierte lernen"))

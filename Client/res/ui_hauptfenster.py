...
"selection-color: rgb(0, 0, 0);]")
        ...
        self.mn_QuizletImportieren = QtWidgets.QAction(MainWindow)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/res/icons/language_FILL1_wght400_GRAD0_opsz24.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mn_QuizletImportieren.setIcon(icon24)
        self.mn_QuizletImportieren.setObjectName("mn_QuizletImportieren")
        ...
        self.menuImportieren.addAction(self.mn_QuizletImportieren)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mn_QuizletImportieren.setText(_translate("MainWindow", "Von Quizlet importieren"))

...
class Ui_Einstellungen(object):
    def setupUi(self, Einstellungen):
        ...
        self.cmd_DatenbankExportieren = QtWidgets.QPushButton(self.frame)
        self.cmd_DatenbankExportieren.setObjectName("cmd_DatenbankExportieren")
        self.horizontalLayout_14.addWidget(self.cmd_DatenbankExportieren)
        ...
        spacerItem12 = QtWidgets.QSpacerItem(20, 205, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Einstellungen):
        ...
        self.label_2.setText(_translate("Einstellungen", "Stil:"))
        ...
        self.cmb_stil.setItemText(2, _translate("Einstellungen", "Nostalgisch"))
        ...
        self.cmd_DatenbankExportieren.setText(_translate("Einstellungen", "Datenbank exportieren"))

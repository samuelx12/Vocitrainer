...
class Ui_Einstellungen(object):
    def setupUi(self, Einstellungen):
        ...
        self.box_willkommenMeldung = QtWidgets.QCheckBox(self.frame)
        self.box_willkommenMeldung.setObjectName("box_willkommenMeldung")
        self.horizontalLayout_8.addWidget(self.box_willkommenMeldung)
        self.cmd_anzeigen = QtWidgets.QPushButton(self.frame)
        self.cmd_anzeigen.setObjectName("cmd_anzeigen")
        self.horizontalLayout_8.addWidget(self.cmd_anzeigen)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(20, 249, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)

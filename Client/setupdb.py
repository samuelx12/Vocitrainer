...
VALUES ('Haus', 'House', 'Eine Unterkunft für Menschen.', 'Bsp: Ich wohne in einem Haus.', 1, 0, 1, 0)""")
cursor.execute("""
INSERT INTO karte (wort, fremdwort, definition, bemerkung, set_id, lernfortschritt, markiert, schwierigkeit) 
VALUES ('Auto', 'Car', 'Ein Fahrzeug mit vier Rädern.', 'Bsp: Er fährt mit dem Auto.', 1, 0, 0, 0)""")
cursor.execute("""
INSERT INTO karte (wort, fremdwort, definition, bemerkung, set_id, lernfortschritt, markiert, schwierigkeit) 
VALUES ('Apfel', 'Apple', 'Eine runde Frucht zum Essen.', 'Bsp: Du isst einen Apfel', 1, 0, 1, 0)""")

cursor.execute("""
INSERT INTO karte (wort, fremdwort, definition, bemerkung, set_id, lernfortschritt, markiert, schwierigkeit) 
VALUES ('blau', 'blue', 'Die Frabe des Himmels.', 'Der Himmel ist blau.', 2, 0, 1, 0)""")
cursor.execute("""
INSERT INTO karte (wort, fremdwort, definition, bemerkung, set_id, lernfortschritt, markiert, schwierigkeit) 
VALUES ('grün', 'green', 'Die Farbe der Pflanzen.', 'Das Gras ist grün.', 2, 0, 0, 1)""")
cursor.execute("""
INSERT INTO karte (wort, fremdwort, definition, bemerkung, set_id, lernfortschritt, markiert, schwierigkeit) 
VALUES ('rot', 'red', 'Die Farbe der Liebe.', 'Ich zeichne eine rote Blume.', 2, 0, 1, 0)""")
